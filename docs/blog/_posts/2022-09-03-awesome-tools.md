...
- [windows 自动化工具](https://tinytask.net/)

- [虚拟定位](https://github.com/ZCShou/GoGoGo)

- [audacity-au 开源替代](https://github.com/audacity/audacity/releases)

- [hiddify-代理软件](https://github.com/hiddify/hiddify-next)

- [oblivion-第三方 cloudflare warp 客户端](https://github.com/bepass-org/oblivion-desktop)
...
- [自托管 pdf 处理](https://github.com/Stirling-Tools/Stirling-PDF)
...
- [Send Big Files up to 5GB Securely. Tresorit Send: Secure, Fast & Free](https://send.tresorit.com/)
...
- [anytext-searcher](https://anytxt.net/)
...
- [Win11Debloat-移除 win11 冗余](https://github.com/Raphire/Win11Debloat)

- [rytunex-windows 优化](https://rayenghanmi.github.io/rytunex/index.html)
...
- [dagu-带 ui 的 cron 替代](https://github.com/dagu-dev/dagu)

- [coolify-托管工具 vercel 开源替代](https://github.com/coollabsio/coolify)
...
- [websoft9-开源 linux 应用](https://www.websoft9.com/)

- [公共 api](https://github.com/public-api-lists/public-api-lists)
...
- [matcha-纯 css 嵌入式语义 yang'shi](https://matcha.mizu.sh/)
...
- [sink-基于 cloudflare 的短链](https://sink.cool/)
...
- [steam 信息网](https://steamdb.info/)

- [世界森林声音地图](https://timberfestival.org.uk/soundsoftheforest-soundmap/)

- [很 cool 的主页](https://www.igloo.inc/shadcn)

- [github 收藏标签](https://starflare.app/#/login)
...
- [appswithcode](https://appswithcode.org/)
